        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with programming and have been building ever
              since.
              <br />
              ...
              <i>
                <b className="purple">web experiences and LLM-powered</b>
              </i>{" "}
              products, along with broader work in
              <i>
                <b className="purple"> AI.</b>
              </i>
              <br />
              <br />
              Whenever possible, I apply that passion to building products with{" "}
